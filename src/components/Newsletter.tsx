  ...
  return (
    <section className="py-24 bg-[#F5F5F5]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative bg-[#007D71] rounded-3xl px-8 py-16 md:p-20 shadow-2xl overflow-hidden">
          ...
          />
          {/* Glow effects */}
          <div className="absolute -top-20 -right-20 w-60 h-60 bg-[#C4743F]/10 rounded-full blur-[80px] pointer-events-none" />
          ...
          <div className="relative z-10 text-center max-w-xl mx-auto">
            <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mx-auto mb-8">
              <Mail size={26} className="text-[#C4743F]" />
            </div>
            <h2 className="text-3xl md:text-4xl font-serif font-black text-white tracking-tight mb-4">
              Join the{" "}
              <span className="text-[#C4743F] italic">Tasty World</span> Club
            </h2>
            ...
            {!subscribed ? (
              ...
              >
                <div className="flex-grow bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 focus-within:border-[#C4743F]/40 focus-within:bg-white/15 transition-all p-1">
                  <input
                    type="email"
                ...
                <button
                  type="submit"
                  className="bg-[#C4743F] text-[#007D71] px-8 py-4 rounded-xl font-bold uppercase tracking-wider text-[11px] hover:bg-[#d4b76e] transition-all shadow-xl shadow-[#C4743F]/15 flex items-center justify-center gap-2.5 active:scale-95 group shrink-0"
                >
                  Subscribe{" "}
                  <Send
                    size={14}
