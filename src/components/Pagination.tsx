      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 order-1 sm:order-2">
          <button
            ...
            className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-[#007D71] hover:text-white disabled:opacity-20 disabled:hover:bg-gray-50 disabled:hover:text-gray-400 disabled:cursor-not-allowed transition-all"
          >
            <ChevronLeft size={18} />
          </button>
              ...
              page === "..." ? (
                ...
                <button
                  ...
                  className={`w-10 h-10 sm:w-11 sm:h-11 rounded-xl text-xs font-black transition-all ${
                    currentPage === page
                      ? "bg-[#007D71] text-white shadow-lg shadow-[#007D71]/20 scale-110"
                      : "bg-gray-50 text-gray-400 hover:bg-[#007D71]/10 hover:text-[#007D71]"
                  }`}
                >
                  {page}
                </button>
