      ...
      <div className="w-full px-6 md:px-12 lg:px-24 relative z-10 pt-44 pb-20">
        <div className="max-w-3xl">
          ...
          >
            <Link
              href="/shop"
              className="bg-[#C4743F] text-[#007D71] px-10 py-5 rounded-2xl font-bold uppercase tracking-wider text-[12px] shadow-xl shadow-[#C4743F]/20 hover:bg-[#d4b76e] transition-all active:scale-95 flex items-center gap-3 group"
            >
              Shop Now
              <ArrowRight
                size={16}
