...
export default function CTASection() {
  return (
    <section className="py-24 lg:py-32 bg-[#007D71]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              <div className="space-y-4">
                <p className="text-[#C4743F] text-sm font-semibold tracking-widest uppercase flex items-center gap-3">
                  <span className="w-8 h-[1px] bg-[#C4743F]"></span>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
                <Link
                  href="/shop"
                  className="group bg-[#C4743F] hover:bg-[#A85D30] text-[#007D71] px-8 py-4 rounded-xl font-bold uppercase tracking-wider text-sm transition-all duration-300 flex items-center justify-center gap-3 shadow-lg w-full sm:w-auto"
                >
                  Shop All Products
                  <ArrowRight
                    size={18}
            ...
            >
              {[
                ...
                <div key={index} className="flex items-start gap-4">
                  <CheckCircle2
                    size={24}
                    className="text-[#C4743F] shrink-0 mt-0.5"
                    strokeWidth={1.5}
                  />
                  <div>
