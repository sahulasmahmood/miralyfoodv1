...
function buildStatusConfig(
  ...
  const base: StatusConfig = {
    ...
    badgeStyle:
      "background:rgba(198,167,94,0.15);color:#C4743F;border:1px solid rgba(198,167,94,0.3);",
    badgeColor: "#C4743F",
  ...
  switch (status) {
    ...
    case "OutForDelivery":
      return {
        ...
        badgeStyle:
          "background:rgba(160,112,80,0.15);color:#C4743F;border:1px solid rgba(160,112,80,0.3);",
        badgeColor: "#C4743F",
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
      ...
      <tr>
        ...
        <td valign="top" width="34%" style="padding:20px 22px;">
          ...
          <div style="font-size:14px;font-weight:700;color:${isCancelled ? "#A85D30" : "#fff"};">${formattedTotal}</div>
  ...
  const discountRow =
    (order.discountPrice ?? 0) > 0
      ? `<tr>
          ...
          <td align="right" style="padding:8px 0;border-bottom:1px solid #E5DDCB;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#C4743F;">-${fmt(order.discountPrice ?? 0)}</td>
        </tr>`
      : "";
  ...
  return `
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
      ...
      <tr>
        ...
        <td align="right" style="padding:14px 0 0;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:800;color:#A85D30;">${fmt(order.totalPrice)}</td>
      </tr>
    </table>
    ...
    <tr>
      <td align="center" valign="top" style="padding:28px 10px;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="ec"
          ...
          <!-- ── ZIGZAG cream → dark ────────────────────────────── -->
          <tr><td style="padding:0;font-size:0;line-height:0;">${buildZigzag("#FDF9EB", "#007D71", "up")}</td></tr>
