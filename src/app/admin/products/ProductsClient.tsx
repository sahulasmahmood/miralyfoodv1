    ...
    <div className="space-y-8 font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6 bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] border border-gray-100 shadow-sm transition-all">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-[#007D71] text-white px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-black shadow-lg shadow-primary/20 hover:bg-[#1a3a14] transition-all flex items-center justify-center gap-2 active:scale-95 text-[10px] sm:text-xs uppercase tracking-widest"
        >
          <Plus size={18} />
              ...
              return (
                <motion.div
                  ...
                  className={`group bg-white rounded-2xl sm:rounded-[20px] p-3 sm:p-4 border hover:shadow-lg transition-all duration-300 flex flex-row items-center gap-3 sm:gap-6 relative overflow-hidden focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation ${
                    p.isActive !== false
                      ? "border-gray-100 hover:border-[#C4743F]/30 hover:shadow-[#C4743F]/5"
