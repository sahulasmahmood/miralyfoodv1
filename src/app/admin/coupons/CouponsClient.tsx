                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="w-full bg-[#F5F5F5] border-none focus:ring-2 focus:ring-primary/20 rounded-2xl py-4 px-6 pr-12 outline-none transition-colors font-medium text-gray-700 appearance-none cursor-pointer"
                          >
