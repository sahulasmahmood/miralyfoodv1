              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-row md:flex-row items-center gap-4 sm:gap-8 md:gap-12 w-full md:w-auto justify-between md:justify-end shrink-0 border-t md:border-t-0 border-gray-50 pt-3 md:pt-0">
                    ...
                    <div className="bg-[#FAF3E0] p-2.5 sm:p-3 rounded-xl text-[#C4743F] sm:opacity-0 sm:group-hover:opacity-100 transform sm:translate-x-4 sm:group-hover:translate-x-0 transition-all active:scale-90">
                        ...
                        <div className="p-6 rounded-2xl border border-gray-100 bg-gray-50 text-center">
                          ...
                          <div className="flex gap-4 justify-center">
                            <button
                              ...
                              className="px-6 py-3 bg-[#007D71] text-white rounded-xl text-xs font-bold uppercase tracking-widest shadow-lg hover:bg-[#1a3a14] transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                            >
                              Manage Stock
                            </button>
                          </div>
                  ...
                  <AnimatePresence>
                    {actionType && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 10 }}
                        className="bg-[#FAF3E0] p-6 rounded-[24px] border border-[#C4743F]/20 relative overflow-hidden"
                      >
                            ...
                            <div className="col-span-2">
                              ...
                              <div className="relative">
                                <select
                                  ...
                                  className={`w-full bg-white p-3 pr-10 rounded-xl outline-none font-medium cursor-pointer appearance-none transition-shadow focus-visible:ring-2 focus-visible:ring-[#C4743F]/50 touch-manipulation ${fieldErrors.reason ? "ring-2 ring-red-300" : ""}`}
                                >
