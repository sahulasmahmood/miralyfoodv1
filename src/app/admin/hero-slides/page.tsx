    ...
    <div className="min-h-screen bg-[#F5F5F5] font-['Inter',sans-serif]">
      <div className="mx-auto py-8 px-4 md:px-8">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6 bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] border border-gray-100 shadow-sm mb-8 sm:mb-10">
          ...
          <button
            onClick={() => openEditor()}
            className="w-full sm:w-auto bg-[#C4743F] text-white px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-black shadow-lg shadow-[#C4743F]/20 hover:bg-[#b0934e] transition-all flex items-center justify-center gap-2 active:scale-95 text-[10px] sm:text-xs uppercase tracking-widest"
          >
            <Plus size={18} />
              ...
              >
                ...
                <div className="flex items-center justify-end gap-3 px-8 py-5 border-t border-gray-100 bg-gray-50/50">
                  ...
                  <button
                    ...
                    className="bg-[#C4743F] hover:bg-[#b0934e] text-white px-8 py-3 rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg shadow-[#C4743F]/20 hover:shadow-xl transition-all"
                  >
                    {saving === "save" ? (
